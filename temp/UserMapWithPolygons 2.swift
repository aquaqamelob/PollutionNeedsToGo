...
//    let isGreenZone: Bool // Green = XP zone
//}
//
//
...
//            CombinedMap(region: $region, showPolygons: showPolygons, userLocation: locationManager.userLocation)
...
//        
//        // Initial centering on user location if available
